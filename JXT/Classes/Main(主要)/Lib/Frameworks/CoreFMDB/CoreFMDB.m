...
+(void)initialize{
    ...
    NSString* projectPath=[[NSBundle mainBundle]pathForResource:@"学车通" ofType:@"sql"];//获取工程目录
...
//        NSLog(@"早写进来了:%@",dbPath);
    ...
    else //若沙盒中没有
    {
        ...
        [file copyItemAtPath:projectPath toPath:dbPath error:&error];
        
//        NSLog(@"写入没有,已经写入:%@",dbPath);
    }
